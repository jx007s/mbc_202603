...
<script>
    import recToT from './components/computed/recToT.vue'; // 1. 파일로드 및 이름지정
    import Capsule from './components/computed/Capsule.vue';
...
import StyleGo from './components/styleee/StyleGo.vue';
